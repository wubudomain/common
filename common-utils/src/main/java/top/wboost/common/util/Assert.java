...
public class Assert {
    ...
    public static void doesNotContain(String textToSearch, String substring, String message) {
        if (StringUtil.notEmpty(textToSearch) && StringUtil.notEmpty(substring) && textToSearch.contains(substring)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static void isInstanceOf(Class<?> type, Object obj, String message) {
        ...
        if (!type.isInstance(obj)) {
            throw new IllegalArgumentException((StringUtil.notEmpty(message) ? message + " " : "") + "Object of class ["
    ...
    public static void isAssignable(Class<?> superType, Class<?> subType, String message) {
        ...
        if (subType == null || !superType.isAssignableFrom(subType)) {
            throw new IllegalArgumentException((StringUtil.notEmpty(message) ? message + " " : "") + subType
    ...
    /*public static void notNull(Object object, String message) {
        if (object == null) {
            if (message.startsWith("@")) {
                message = message.substring(1) + "\t" + Prompt.VALIDATE_NULL;
            }
            throw new IllegalArgumentException(message);
        }
    }*/
