 ...
 * @param <V>
 */
public class BaseJpaServiceImpl<T, K extends BaseJpaRepository<T, ?>> extends BaseServiceImpl<T>
        implements BaseJpaService<T, String> {

    public BaseJpaServiceImpl(BaseJpaRepository<T, String> repository) {
        super();
    ...
    protected BaseJpaRepository<T, String> repository;

    private BaseJpaRepository<T, String> getBaseRepository() {
    ...
    @Override
    public void setRepository(BaseRepository<T, String> repository) {
        this.repository = (BaseJpaRepository<T, String>) repository;
    }
