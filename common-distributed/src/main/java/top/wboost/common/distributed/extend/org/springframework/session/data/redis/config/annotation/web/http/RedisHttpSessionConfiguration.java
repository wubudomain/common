package top.wboost.common.distributed.extend.org.springframework.session.data.redis.config.annotation.web.http;
...
/**
 * 使用spring-session配置类,使用 @Bean 注册
 * @author jwSun
 * @date 2017年6月6日 下午7:05:24
 */
@Configuration
@EnableScheduling
