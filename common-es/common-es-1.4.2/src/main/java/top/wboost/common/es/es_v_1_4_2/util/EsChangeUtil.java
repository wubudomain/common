...
import top.wboost.common.es.es_v_1_4_2.entity.EsIndex;
import top.wboost.common.es.es_v_1_4_2.entity.EsPut;

/**
 * ES更改工具类
 * @author jwSun
 * @date 2017年5月2日 上午11:34:08
 */
public class EsChangeUtil extends AbstractEsUtil {
    ...
    public static Boolean createIndex(EsIndex index) {
        try {
            Settings settings = ImmutableSettings.settingsBuilder().put("number_of_shards", index.getNumber_of_shards())
