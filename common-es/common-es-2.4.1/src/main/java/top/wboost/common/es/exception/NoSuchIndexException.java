 ...
 */
public class NoSuchIndexException extends EsSearchException {

    /**
     * @author jwSun
     * @date 2017年6月23日 下午5:29:25
     */
     ...
     * @since 1.7
     */
    protected NoSuchIndexException(String message, Throwable cause, boolean enableSuppression,
