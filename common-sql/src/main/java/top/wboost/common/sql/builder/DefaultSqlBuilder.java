...
public class DefaultSqlBuilder {
    ...
    public static void main(String[] args) {
        ...
        sqlBuilder.setPage(new BasePage(2, 5));
        System.out.println(sqlBuilder.build().toQueryString());
    ...
    public interface SqlBody<T extends SqlBody<T>> {
         ...
         * 增加查找函数
         * @param alias 函数字段别名
         * @param sqlFunction {@link top.wboost.common.sql.enums.SqlFunction}
         ...
         * @param fkColumns 关联外键 如关联 fact.column 则填写 column
         * @param pkColumns 关联主键
         * @param joinType 关联类型 {@link top.wboost.common.sql.fragment.JoinType}
         * @return
         */
        T addJoin(String tableName, String alias, String joinTableAlias, String[] fkColumns, String[] pkColumns,
                JoinType joinType);
        ...
        /**
         * 增加 where条件
         * @param fragment 见{@link top.wboost.common.sql.builder.SqlCondition}
         * @return
         */
        ...
        /**
         * 增加 having条件
         * @param fragment 见{@link top.wboost.common.sql.builder.SqlHavingCondition}
         * @return
         */
        ...
        /**
         * 增加分页条件
         * @param page {@link top.wboost.common.base.page.BasePage}
         * @return
         */
    ...
    private static class DefaultSqlBodyBuilderImpl implements DefaultSqlBodyBuilder {
        ...
        public DefaultSqlBodyBuilder setPage(BasePage page) {
            if (page == null) {
                throw new SqlBuilderException("page is null");
            }
